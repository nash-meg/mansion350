...
public class UI {
    ...
    public void createUI(Game.TitleScreenHandler handler){
        ...
        /**Button so that you can choose a button to make a choice*/
        ...
        /**the make the difference for each buttons*/
        choice1.setActionCommand("c1");
        chooseButton.add(choice1);
        ...
        choice5.addActionListener(handler);
